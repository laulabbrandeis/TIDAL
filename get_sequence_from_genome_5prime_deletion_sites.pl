...
#    my $breakpoint = $chr_end + $SEQ_BUFFER;
#    my $seq_start = $breakpoint-$SEQ_BUFFER-$LIMIT-$SEQ_BUFFER;
#    my $seq_end =  $breakpoint;

    my $breakpoint = $chr_end + $SEQ_BUFFER;
    my $seq_start = $breakpoint-$SEQ_BUFFER-$SEQ_BUFFER; # -$LIMIT-$SEQ_BUFFER;
    my $seq_end =  $breakpoint +  $LIMIT + $LIMIT; #half the read
